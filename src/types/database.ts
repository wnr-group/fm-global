...
export interface Database {
  public: {
    Tables: {
      ...
      // ➕ NEW — dynamic categories for Placement page
      placement_categories: {
        Row: {
          id: string
          title: string
...
// ➕ NEW helper type for placement_categories
export type PlacementCategory = Database['public']['Tables']['placement_categories']['Row']