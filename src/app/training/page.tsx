              ...
              <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 mb-12">
                    <Link href="/contact">
                      <Button size="lg" className="w-full sm:w-auto gap-2 h-12 px-6 shadow-lg shadow-primary/25 bg-[var(--cta-bg)] hover:bg-[var(--cta-bg)]/90 hover:shadow-xl hover:shadow-primary/30 active:scale-[0.98] transition-all duration-200">
                        Enquire Now
              ...
              <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link href="/contact">
                    <Button
                      size="lg"
                      className="w-full sm:w-auto gap-2 h-14 px-8 shadow-lg shadow-primary/25 bg-[var(--cta-bg)] hover:bg-[var(--cta-bg)]/90 hover:shadow-xl hover:shadow-primary/30 active:scale-[0.98] font-semibold transition-all duration-200"
                    >
                      Enquire Now
