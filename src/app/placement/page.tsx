...
export default function PlacementPage() {
  return (
    <main className="placement-theme min-h-screen bg-background">
        {/* Hero Section */}
        <section
                  ...
                  <div className="relative aspect-square max-w-md mx-auto">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="w-24 h-24 rounded-full bg-primary/10 flex items-center justify-center animate-fade-in delay-200">
                        <Globe2 className="w-12 h-12 text-accent" />
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-5">
              {regions.map((region, index) => (
                <ScrollReveal key={region.id} delay={index * 50}>
                  <article className="group h-full bg-background rounded-2xl p-6 lg:p-8 border border-accent/30 hover:border-primary/30 hover:shadow-xl hover:shadow-primary/10 hover:-translate-y-1 transition-all duration-300 ease-out">
                    {/* Header */}
                    ...
                    <div className="mb-5">
                      ...
                      <div className="flex flex-wrap gap-1.5">
                        {region.industries.map((industry) => (
                          <span
                            key={industry}
                            className="text-xs px-2.5 py-1 rounded-full bg-accent/10 text-foreground"
                          >
                            {industry}
                          </span>
                        ))}
          ...
          <div className="w-full px-5 sm:px-8 lg:px-[6%] xl:px-[8%]">
            ...
            <div className="border-t border-background/10 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
              ...
              <p className="text-xs text-background/40">
                Connecting Skilled Talent with Global Opportunities
              </p>
            </div>
          </div>
        </footer>
